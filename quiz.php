...
<head>
  ...
  <link rel="apple-touch-icon" href="images/favicon.png">
    ...
    <!--  google font-muli-link -->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700|Muli:400,600" rel="stylesheet">
...
<footer>
    <div class="it-footer-area it-footer-bg black-bg pt-120 pb-70">
        ...
        <ul>
        <li class="last"><i class="fas fa-angle-right"></i>Career counselling by Expert counsellor</li>
        <li class="last"><i class="fas fa-angle-right"></i>Admission Guidance</li>
        <li class="last"><i class="fas fa-angle-right"></i>Education Loan Assistance</li>
        </ul>
        </div>
        </div>
        </div>
